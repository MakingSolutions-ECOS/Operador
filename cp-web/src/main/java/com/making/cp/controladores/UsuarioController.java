...
public class UsuarioController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, "Usuario creado exitosamente");
    ...
    public void update() {
        persist(PersistAction.UPDATE, "Usuario modificado exitosamente");
    }

    public void destroy() {
        persist(PersistAction.DELETE, "Usuario eliminado exitosamente");
        if (!JsfUtil.isValidationFailed()) {
