...
public class PermisoController implements Serializable {
    ...
    private PermisoFacadeLocal getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, "Permiso creado exitosamente");
    ...
    public void update() {
        persist(PersistAction.UPDATE, "Permiso modificado exitosamente");
    }

    public void destroy() {
        persist(PersistAction.DELETE, "Permiso eliminado exitosamentes");
        if (!JsfUtil.isValidationFailed()) {
