...
/**
 * <p>Clase Java para iniciarTramiteResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="iniciarTramiteResponse">
 *   &lt;complexContent>
...
@XmlType(name = "iniciarTramiteResponse", propOrder = {
    "_return"
})
public class IniciarTramiteResponse {
