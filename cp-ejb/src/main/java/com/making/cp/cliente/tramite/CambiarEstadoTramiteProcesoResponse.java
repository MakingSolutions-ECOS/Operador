...
/**
 * <p>Clase Java para cambiarEstadoTramiteProcesoResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="cambiarEstadoTramiteProcesoResponse">
 *   &lt;complexContent>
...
@XmlType(name = "cambiarEstadoTramiteProcesoResponse", propOrder = {
    "_return"
})
public class CambiarEstadoTramiteProcesoResponse {
